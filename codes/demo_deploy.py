...
def deploy(args, sr_model):
    ...
    with torch.no_grad():
        for i in range(len(img_lists)):
            ...
            final_sr = np.rint(final_sr).astype(int)
...
if __name__ == '__main__':
    ...
    args.pre_train = '../experiment/test/model/model_best.pt'
    args.dir_data = 'D:/BaiduNetdiskDownload/UCMerced-dataset/UCMerced-dataset/test/LR_x4/'
    args.dir_out = '../experiment/test/results/UCMerced-dataset/x4/TransENet'
